...
print(shoppingBasket[:4])  # if i give end position , it returns the first n elements : where n points to the integer
# given
...
# to change a range of item values to change the values in a specific range , define a list with the new values and
# refer to the index numbers where we want to insert the index values
